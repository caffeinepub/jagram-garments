...
import type { CartItem as _CartItem, Category as _Category, Order as _Order, OrderStatus as _OrderStatus, Product as _Product, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async initializeSampleProducts(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.initializeSampleProducts();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
